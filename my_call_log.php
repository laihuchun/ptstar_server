...
$sql = "select call_time,call_no,case call_type when 0 then '呼入' when 1 then '呼出' end from call_log where user_id = (select user_id from user where wechat_no = '$openid');";
$aa = get_select($sql);
